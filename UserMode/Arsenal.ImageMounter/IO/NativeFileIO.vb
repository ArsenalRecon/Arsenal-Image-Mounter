        ...
        Public Class Win32API
            ...
            Public Structure SCSI_ADDRESS
                ...
                Public Overloads Function Equals(other As SCSI_ADDRESS) As Boolean Implements IEquatable(Of SCSI_ADDRESS).Equals
                    Return _
                        PortNumber = other.PortNumber AndAlso
                        PathId = other.PathId AndAlso
                        TargetId = other.TargetId AndAlso
                        Lun = other.Lun
                End Function
            ...
            Public Declare Auto Function QueryDosDevice Lib "kernel32.dll" (
              lpDeviceName As String,
              <Out(), MarshalAs(UnmanagedType.LPArray, SizeParamIndex:=2)> lpTargetPath As Char(),
...
#End Region
        ...
        Public Shared Function GetScsiAddress(hDevice As SafeFileHandle) As Win32API.SCSI_ADDRESS
            ...
            Win32Try(Win32API.DeviceIoControl(hDevice, Win32API.IOCTL_SCSI_GET_ADDRESS, IntPtr.Zero, 0, ScsiAddress, CUInt(Marshal.SizeOf(GetType(Win32API.SCSI_ADDRESS))), Nothing, Nothing))
        ...
        Public Shared Function QueryDosDevice(DosDevice As String) As String()
            ...
            Dim Target As New String(TargetPath, 0, CInt(length))

            Return Target.Split({New Char})
        ...
        Public Shared Function OpenDiskByScsiAddress(ScsiAddress As Win32API.SCSI_ADDRESS, AccessMode As FileAccess) As KeyValuePair(Of String, SafeFileHandle)
            ...
            For Each diskdevice In
                From device In QueryDosDevice()
                Where
                    device.StartsWith("PhysicalDrive", StringComparison.InvariantCultureIgnoreCase) OrElse
                    device.StartsWith("CdRom", StringComparison.InvariantCultureIgnoreCase)
